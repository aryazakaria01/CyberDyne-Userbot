...
# ========================= CONSTANTS ============================
AFKSTR = [
    f"**Maaf {ALIVE_NAME} Sedang ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡**",
    f"**Maaf {ALIVE_NAME} Sedang ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡\n Tunggu Sampai Online!**",
    f"**{ALIVE_NAME} Sedang ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡\n Tunggulah Sampai Online**",
...
async def set_afk(afk_e):
    ...
    if string:
        AFKREASON = string
        await afk_e.edit(
            f"**👤 {ALIVE_NAME} ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡**\
        \n╰► **Reason :** `{string}`"
        )
    else:
        await afk_e.edit(f"**👤 {ALIVE_NAME} ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡**")
    if user.last_name:
        await afk_e.client(
            UpdateProfileRequest(
                first_name=user.first_name, last_name=user.last_name + "⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡"
            )
        )
    else:
        await afk_e.client(
            UpdateProfileRequest(first_name=user.first_name, last_name="⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡")
        )
    if BOTLOG:
        await afk_e.client.send_message(
            BOTLOG_CHATID, f"#UPDATE\n{ALIVE_NAME} ⚡𝓞𝓕𝓕𝓛𝓘𝓝𝓔⚡!"
        )
    ISAFK = True
